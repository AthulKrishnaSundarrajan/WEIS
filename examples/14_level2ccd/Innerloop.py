...
def Calc_DV(mydir):
    ...
    sql_path = mydir + os.sep + "log_opt.sql"
...
if __name__ == "__main__":
    ...
    # Linear Model
    analysis_dir = mydir + os.sep + "outputs" + os.sep + "jmd_single" 
    ...
    for n in range(1):
        ...
        summary_stats, extreme_table, DELs, Damage = dtqp_wrapper(LinearTurbine, level2_disturbance, analysis_options, fst_vt, la, magnitude_channels, run_directory,cores = 1 )
